...
#build image karsajobs dengan tag latest dari Dockerfile
echo "-------------------------------------------------------------"
echo -e "Build image....\n"
docker build -t ghcr.io/teddy-harfa/karsajobs:latest .
...
docker push ghcr.io/teddy-harfa/karsajobs:latest
